...
class SykloService {
    constructor() {
        this.URL_P2P = "https://explorer.syklo.io/widget#send_pms=VES:VE:PF,VES:VE:VEBN28,VES:VE:VEBN1,VES:VE:VEBN5,VES:VE:VEBN15&receive_pms=USD:ALL:ZI,USD:ALL:WTE&is_sending=false&local_amount=100";
        this.SELECTORS = {
